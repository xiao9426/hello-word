...
install_ss_panel(){
	...
	git clone https://github.com/xiao942622/ss-panel.git "/home/wwwroot/default"
...
install_ss_py_mu(){
	...
	git clone https://github.com/xiao942622/shadowsocks-py-mu.git "/root/shadowsocks-py-mu"
	#modify Config.py
