...
install_ss_panel_mod_v3(){
	...
	wget -c https://raw.githubusercontent.com/xiao942622/ss-panel-and-ss-py-mu/master/lnmp1.3.zip && unzip lnmp1.3.zip && cd lnmp1.3 && chmod +x install.sh && ./install.sh lnmp
	cd /home/wwwroot/default/
	yum install git -y
	rm -rf index.html
	wget https://raw.githubusercontent.com/xiao942622/ss-panel-and-ss-py-mu/master/ss.panel_mod.zip && unzip ss.panel_mod.zip
	chattr -i .user.ini
	mv .user.ini public
	chown -R root:root *
	chmod -R 777 *
	...
	wget -N -P  /usr/local/nginx/conf/ https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/nginx.conf 
	...
	wget https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/radiusd.conf -O /etc/raddb/radiusd.conf
	wget https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/default -O /etc/raddb/sites-enabled/default
	wget https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/dialup.conf -O /etc/raddb/sql/mysql/dialup.conf
	wget https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/dictionary -O /etc/raddb/dictionary
	wget https://raw.githubusercontent.com/xiao942622/hello-word/xiao942622-patch-1/counter.conf -O /etc/raddb/sql/mysql/counter.conf
...
install_ssr(){
	...
	wget https://raw.githubusercontent.com/xiao942622/ss-panel-and-ss-py-mu/master//libsodium-1.0.11.tar.gz
	...
	#clone shadowsocks
	cd /root
	git clone -b manyuser https://github.com/xiao942622/shadowsocks.git "/root/shadowsocks"
	#install devel
	cd /root/shadowsocks
